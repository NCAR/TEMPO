module module_mp_tempo_main
    ...
    subroutine tempo_main(qv1d, qc1d, qi1d, qr1d, qs1d, qg1d, qb1d, ni1d, nr1d, nc1d, ng1d, &
        ...
        do k = kts, kte
            ...
            delqvs(k) = max(0.0, calc_rslf(pres(k), 273.15)-qv(k))
...
!!!                    + tnr_gacr(idx_g1,idx_g,idx_table(k),idx_r1,idx_r)
                ...
                if (temp(k).lt.T_0) then
                    ...
                    ! if (dustyIce) then
                    if (dustyIce .and. (tempo_init_cfgs%aerosolaware_flag .or. merra2_aerosol_aware)) then
                    ...
                    if ((tempo_init_cfgs%aerosolaware_flag .or. merra2_aerosol_aware) .and. homogIce .and. &
        ...
        do k = kts, kte
            ...
            if ((ssatw(k).gt. eps) .or. (ssatw(k).lt. -eps .and. L_qc(k))) then
                ...
                if (xrc > R1) then
                    ...
                    !+---+-----------------------------------------------------------------+ !  DROPLET NUCLEATION
                    if (clap .gt. eps) then
                        if (tempo_init_cfgs%aerosolaware_flag .or. merra2_aerosol_aware) then
                            rand = 0.0
                            if (present(rand3)) then
                                rand = rand3
                            endif
                        ...
                        !+---+-----------------------------------------------------------------+ !  EVAPORATION
                    elseif (clap .lt. -eps .AND. ssatw(k).lt.-1.e-6 .and. tempo_init_cfgs%aerosolaware_flag) then
                        tempc = temp(k) - 273.15
                        otemp = 1./temp(k)
                        rvs = rho(k)*qvs(k)
                ...
                if (tempo_init_cfgs%aerosolaware_flag) nwfaten(k) = nwfaten(k) - pnc_wcd(k)
